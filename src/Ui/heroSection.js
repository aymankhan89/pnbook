...
// import herosectionImg from "../../public/herSectionImg.svg"
// import trustLogos from "../trustLogos.svg"
...
function HeroSection({
  ...
  return (
   ...
   <section className="bg-[#214651] mt-[56px] w-[90%] rounded-[14px] h-[600px] flex ">
    ...
    <img className='w-[85px] h-[21px]' src="/trustLogos.svg"alt="" />
        <p className='font-[400] text-[15px] text-[#FBFBFB]'>{logoDesciption}</p>
    </div>
<div className=' w-[738px] flex flex-col gap-[25px]'> 
       ...
       <div className='flex gap-[20px] pt-[60px]'>   <a
            href={primaryButtonLink}
            className="text-[#214651] border text-[16px] font-[600] h-[42px] w-[121px] rounded-[11px] bg-[#FBFBFB] justify-center flex items-center"
          >
            {primaryButtonText}
          ...
          <a
            ...
            className="text-[#FBFBFB] border text-[16px] font-[400] h-[42px] w-[121px] rounded-[11px] justify-center flex items-center "
          >
            {secondaryButtonText}
          </a>
          </div>
        </div>
        <div className="  col-start-8 col-end-13 justify-center items-center ">
          <img src='/herSectionImg.svg' alt="mockup" />
        </div>
      </div>
    </section>
    </div>
